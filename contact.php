                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <form method="post" action="" role="form">
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <button type="submit" name="submit" class="btn btn-secondary py-3 px-5" type="submit">
                                    Send Message</button>
                            </div>
                        </div>
                    </form>
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <div class="d-flex border-bottom pb-3 mb-3">
                        ...
                        <div class="ms-3">
                         ...
                         <span>Plot 8 Wamala Avenue
                                Bukoto-Kissasi Road </span><br>
                    ...
                    <div class="d-flex border-bottom-0 pb-3 mb-3">
                        ...
                        <div class="ms-3">
                            <h6>Mail Us</h6>
                            <span><span>info@zadecadacademy.com</span></span>
                        </div>
                    </div>
