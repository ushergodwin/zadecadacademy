    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-3 col-xs-12">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>{{ $companyAddress?->office_name }}</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>{{ $companyAddress?->office_address }}</p>
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>{{ $companyAddress?->office_po_box }}</p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>{{ $companyAddress?->office_line1 }}</p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>{{ $companyAddress?->office_line2}}</p>
                @if ($companyAddress?->office_line3)
                   <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>{{ $companyAddress?->office_line3}}</p> 
                @endif
                <p class="mb-2"><i class="fa fa-envelope me-3"></i>{{ $companyAddress?->office_email}} </p>
            ...
            <div class="col-lg-3 col-md-3 col-xs-12">
                ...
                @endforeach
                <h5 class="text-white mb-4">MTN Mobile Money</h5>
                  @foreach ($paymentOptions->airtel_money as $item)
                    <p>{{ $loop->index +1 }}. {{ $item }} </p>
                @endforeach
            </div>
            <div class="col-lg-2 col-md-2 col-xs-12">
                ...
                <p><a  href="{{ url('downloads') }}">Downloads</a></p>
...
<a href="#" class="btn btn-lg btn-secondary btn-lg-square rounded-circle back-to-top">
    <i class="bi bi-arrow-up"></i>
        ...
        <div class="wabtn" id="wabutton">
            <a  target="_blank" href="https://wa.me/{{ $companyAddress->office_line3 }}?text=Hello!%20I'm%20interested%20in%20your%20services%20and%20would%20love%20to%20talk%20more" style=" cursor: pointer;height: 48px;width: auto;padding: 7px 7px 7px 7px;position: fixed !important;color: #fff;bottom: 20px;right: unset;display: flex;font-size: 18px;font-weight: 600;align-items: center;z-index: 999999999 !important;background-color: #ff7900;box-shadow: 4px 5px 10px rgba(0, 0, 0, 0.4);border-radius: 100px;animation: pulse 2.5s ease infinite;left: 20px;">
