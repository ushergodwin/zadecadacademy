                        ...
                        <form role="form" method="post" action="">
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="e.g Isaac" name="first" type="text"
                                        autofocus required />
                                </div>
                                <div class="form-group">
                                    <label> Last Name: </label>
                                    <input class="form-control" placeholder="e.g Akatukunda" name="last" type="text"
                                        required />
                                </div>
                                <div class="form-group">
                                    <label> Email: </label>
                                ...
                                <a href="<?php echo SITE_URL; ?>" class="btn btn-success"> <i class="fa fa-key"> </i>
                                    Login </a>
                            </fieldset>
                        </form>
                    </div>
                ...
                <div class="login-panel panel panel-primary" style="border:1px solid #337ab7">
                    <div class="panel-heading">
                        <center>
                            <h3 class="panel-title">
                                <i class="fa fa-lock"></i>
                                <b> ZadeAcademy - Reset Password </b>
                            </h3>
                        </center>
                    </div>
                    <div class="panel-body">
                        ...
                        <form role="form" method="post" action="">
                            ...
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Your reset code sent via email" name="code"
                    ...
                    <div class="panel-body">
                        ...
                        <form role="form" method="post" action="">
                            <fieldset>
                                ...
                                <a href="<?= $login_url; ?>" class="btn btn-success"> <i class="fa fa-globe"> </i> Back
                                    to website </a>
                            </fieldset>
                        </form>
                    </div>
