...
<div class="container-xxl py-5" style="background-color: #fff;">
    <div class="container">
        <div class="row g-5 align-items-end">
            <div class="col-lg-12">
    <p> The ZadeCAD Academy program is mainly useful for and targets both graduates and professionals in the following fields/careers 
    to develop their job-based skills:</p>
